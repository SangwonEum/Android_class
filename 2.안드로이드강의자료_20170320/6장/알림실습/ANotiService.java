...
public class ANotiService extends Service {
...
//             Toast.makeText(getApplicationContext(), "알림!", 0).show();
                ...
                NotificationCompat.Builder builder =
                          new NotificationCompat.Builder(ANotiService.this);
                ...
                // 알림 클릭시 MainActivity를 화면에 띄운다.
                Intent intent = new Intent(getApplicationContext(),ANotiActivity.class);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Toast.makeText(this, "알림 서비스 : "+time, 0).show();
