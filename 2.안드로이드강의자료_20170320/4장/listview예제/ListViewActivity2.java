...
public class ListViewActivity2 extends Activity implements OnItemClickListener{
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int position, long id) {
		...
		{
		case 0 :
			intent = new Intent(ListViewActivity2.this,ChildActivity1.class);
			data=dataList.get(position);
			intent.putExtra("data",data);
			startActivity(intent);
			break;
		case 1 :
			intent = new Intent(ListViewActivity2.this,ChildActivity2.class);
			data=dataList.get(position);
			intent.putExtra("data",data);
			startActivity(intent);
			break;
