...
public class FragmentLayout extends Fragment {
	...
	public static class TitlesFragment extends ListFragment {     
		boolean mDualPane;     int mCurCheckPosition = 0;       
		...
		//	setListAdapter(new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_activated_1, ShakeSpeare.TITLES));         
			setListAdapter(new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_activated_1, 1));
		...
		void showDetails(int index) {        
			...
			if (mDualPane) {            
				...
				if (details == null || details.getShownIndex() != index) {                
					...
					//	ft.replace(R.id.a_items, details);
