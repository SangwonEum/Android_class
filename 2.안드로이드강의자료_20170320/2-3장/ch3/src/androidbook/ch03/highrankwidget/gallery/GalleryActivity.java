...
public class GalleryActivity extends Activity implements OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        activity.add("BasicGallery");
        activity.add("ComplexGallery");
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int position, long id) {
		...
		{
		case 0 :
			intent = new Intent(GalleryActivity.this,BasicGallery.class);
			startActivity(intent);
			break;
		case 1 :
			intent = new Intent(GalleryActivity.this,ComplexGallery.class);
			startActivity(intent);
			break;
		}
