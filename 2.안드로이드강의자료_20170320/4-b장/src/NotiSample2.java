...
public class NotiSample2 extends Activity implements OnClickListener {
    ...
    private void nofity() {
        ...
        Intent intent = new Intent(this, NotiSample2.class);
        PendingIntent pendingIntent = PendingIntent.getActivity(
        		NotiSample2.this, 0, intent, 0);

        Notification notification = new Notification();
        notification.icon = android.R.drawable.ic_input_add;
        notification.tickerText = ticker;
        notification.when = System.currentTimeMillis();
        //1초 진동후,0.1초,정지,다시 1초 진동후 0.1초 정지
        notification.vibrate = new long[] { 1000, 100, 1000, 100 }; 
